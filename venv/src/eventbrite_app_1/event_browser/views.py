...
from eventbrite_api import fetch_categories_events, fetch_categories
import ConfigParser
...
def index(request):
    ...
    if(browse_categories):
        ...
        context.events = fetch_categories_events(browse_categories, context.page, context.page_length)
